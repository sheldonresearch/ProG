        ...
        for a in range(num_iter):
            ...
            if args.task == 'NodeTask':
                tasker = NodeTask(pre_train_model_path = pre_train_model_path, 
                                ...
                                epochs = args.epochs, shot_num = shot_num, device=args.device, lr = params['learning_rate'], wd = params['weight_decay'],
            ...
            if args.task == 'GraphTask':
                tasker = GraphTask(pre_train_model_path = pre_train_model_path, 
                                ...
                                shot_num = shot_num, device=args.device, lr = params['learning_rate'], wd = params['weight_decay'],
