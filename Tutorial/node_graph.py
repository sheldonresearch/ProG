...
from prompt_graph.pretrain import GraphMAE  # noqa: E402
...
train_graphs, test_graphs, train_labels, test_labels = train_test_split(
    graphs, labels, test_size=0.6, random_state=42
)
...
for args.prompt_type in ["Gprompt", "All-in-one"]:
    for idx, dataset in enumerate(data_list):
        tasker = GraphTask(
            pre_train_model_path="Experiment/pre_trained_model/"
            + dataset_name
            + "/GraphMAE.GCN.128hidden_dim.pth",
            dataset_name=dataset_name,
