...
def random_search(param_grid, num_iter=100):
    best_params = None
    best_loss = float('inf')
    ...
    for _ in range(num_iter):
        ...
        if args.task == 'NodeTask':
            tasker = NodeTask(pre_train_model_path = args.pre_train_model_path, 
                            ...
                            epochs = args.epochs, shot_num = args.shot_num, device=args.device, lr = params['lr'], wd = params['wd'],
        ...
        if args.task == 'GraphTask':
            tasker = GraphTask(pre_train_model_path = args.pre_train_model_path, 
                            ...
                            shot_num = args.shot_num, device=args.device, lr = params['lr'], wd = params['wd'],
                            batch_size = params['batch_size'])
