...
python downstream_task.py --pre_train_model_path './pre_trained_gnn/Cora.Edgepred_GPPT.GCN.128hidden_dim.pth' --task NodeTask --dataset_name 'Cora' --gnn_type 'GCN' --prompt_type 'All-in-one' --shot_num 10 --hid_dim 128 --num_layer 3 --epochs 50 --seed 42 --device 5

# Edgepred + Gprompt + GCN
python downstream_task.py --pre_train_model_path './pre_trained_gnn/Cora.Edgepred_GPprompt.GCN.128hidden_dim.pth' --task NodeTask --dataset_name 'Cora' --gnn_type 'GCN' --prompt_type 'Gprompt' --shot_num 10 --hid_dim 128 --num_layer 3 --epochs 50 --seed 42 --device 5
