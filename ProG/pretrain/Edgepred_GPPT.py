...
class Edgepred_GPPT(PreTrain):
    ...
    def generate_loader_data(self):
        if self.dataset_name in ['PubMed', 'CiteSeer', 'Cora']:
        ...
        for epoch in range(1, num_epoch + 1):
            ...
            if train_loss_min > train_loss:
                ...
                torch.save(self.gnn.state_dict(),
                           "../Prog_plus/pre_trained_gnn/{}.{}.{}.{}.pth".format(self.dataset_name, 'Edgepred_GPPT', self.gnn_type, str(self.hid_dim) + 'hidden_dim'))
